...
if (!Array.prototype.lastIndexOf) {
	Array.prototype.indexOf = function (obj, start) {
		for (var i = (start - 1 || this.length - 1), j = -1; i > j; i--) {
			if (this[i] === obj) {
				return i;
			}
		}
...
String.prototype.toArray = function () {
	...
	for (var i = 0; i < this.length; i++) {
		res.push(this.toString().slice(i, i + 1));
	}
	return res;
}
...
String.prototype.toXMLFormat = function () {
	return this.toString().replaceAll('&', '&amp;').replaceAll('"', '&quot;').replaceAll("'", '&apos;').replaceAll('<', '&lt;').replaceAll('>', '&gt;');
}

String.prototype.toXML = function () {
	return '<value>' + this.toString().toXMLFormat() + '</value>'
}
...
Number.prototype.hasObjAttrRef = function (n, i, d) {
	return false;
}
...
String.prototype.hasObjAttrRef = function (n, i, d) {
	return false;
}
